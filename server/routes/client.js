...
class APIClient {
  ...
  async startHfDownload(modelId, targetDir = 'models/base') {
    try {
      ...
      const response = await this.axios.post('/api/hf/download', {
        modelId,
        targetDir
      });
  ...
  async getHfStatus(jobId) {
    try {
      ...
      const response = await this.axios.get(`/api/hf/status/${jobId}`);
      return response;
    } catch (error) {
  ...
  async getHfJobs() {
    try {
      const response = await this.axios.get('/api/hf/jobs');
      return response;
    } catch (error) {
  ...
  async cancelHfDownload(jobId) {
    try {
      const response = await this.axios.post(`/api/hf/cancel/${jobId}`);
      return response;
    } catch (error) {
  ...
  async getTrainingJobs() {
    try {
      const response = await this.axios.get('/training/jobs');
      return response;
    } catch (error) {
  ...
  async getCatalogDatasets() {
    try {
      const response = await this.axios.get('/catalog/datasets');
      return response;
    } catch (error) {
